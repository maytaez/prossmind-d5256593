 ...
 */
const ParticleBackground = ({ useReducedMotion }: ParticleBackgroundProps = {}) => {
  ...
  return (
      ...
      <canvas
        ...
        aria-hidden="true"
      />
      {/* Atmospheric backdrop glow layer - enhanced for brand gradient */}
      <div 
        className="absolute inset-0 opacity-25"
        style={{
          background: 'radial-gradient(circle at 50% 50%, rgba(100, 180, 255, 0.2) 0%, transparent 70%)',
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at 30% 20%, rgba(100, 180, 255, 0.3) 0%, transparent 50%)',
        }}
        aria-hidden="true"
      />
    </div>
